...
public class Towers {
 ...
 public static void solveTowers(int numDiscs, int startPole, int endPole) {
   ...
   {
     solveTowers(numDiscs-1,startPole,inter);
     moveDisc(startPole,endPole);
     solveTowers(numDiscs-1,inter,endPole);
   }
   //If discs>1, move num-1 discs from 0 to 1
   //move the largest disc to 2
   //move 2 discs from 1 to 2
 }
